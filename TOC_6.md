...
# 5. Sockets		
	...
	5.4 Addressing: getaddrinfo and getnameinfo
	5.5 Address formats: inet_ntop and inet_pton
	5.6 Setting the socket address: bind
	5.7 Receiving connections: listen and accept
	5.8 Connecting to sockets: connect
	5.9 Socket information: getsockname, getpeername, getsockopt
	5.10 Data transmission: send and recv
	5.11 Conection-oriented client-server uptime service
...
# 6. UNIX Domain Sockets
	...
	6.4 Stream-oriented sockets and message-oriented sockets
	6.5 Abstract sockets
	6.6 Socket options and ancillary messages: cmsg
	6.7 Passing file descriptors within a single process
	6.8 Passing file descriptors between parent and child processes
...
# 7. Terminal I/O.
	...
	7.4 Canonical, noncanonical and raw mode
	7.5 Line control
	7.6 Line speed
...
# 8. Pseudo terminals
	...
	8.3 Opening pseudoterminal: getpt and posix_openpt
